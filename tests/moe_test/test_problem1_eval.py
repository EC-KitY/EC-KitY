...
from examples.multi_objective.prob1.moe_basic_test import prob1MOAEvaluator


class TestProblem1Eval:
    ...
    def setup_class(self):
        ...
        """
        self.evaluator = prob1MOAEvaluator()
    ...
    def teardown_class(self):
        ...
        """
        pass
    def assert_vector_almost_equal(self,vec1,vec2,tolerance=0.000000000000001):
    ...
    def test_eval_fixed_vals(self):
        ind = MOEitStringVectorCreator(length=3)
...
#### bad test
    # def test_eval_fixed_vals_3_second_half(self):
    #     ind = MOEitStringVectorCreator(length=3)
    #     ind.vector = [-3.5158362080315237, 0.06631935351665152, -2.921231400536878]
    #     actual = self.evaluator._evaluate_individual(ind)
    #     expected = [0.9999999579193197, 0.9999999999998459]
    #     self.assert_vector_almost_equal(actual, expected)
#### bad test
    # def test_eval_fixed_vals_4_second_half_2(self):
    #     ind = MOEitStringVectorCreator(length=3)
    #     ind.vector = [1.6581995119056003, 3.2586491417333265, -3.2631729191512076]
    #     actual = self.evaluator._evaluate_individual(ind)
    #     expected = [1.0, 0.9999999875621212]
    #     self.assert_vector_almost_equal(actual, expected)
