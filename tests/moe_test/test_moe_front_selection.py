...
'''consider writing test with gpt and the following query:  i wrote a function in python that gets an int size and a list of tuples of float (each tuple is size 2 , and represent fitness values ) named fitnesses , the function return a list that represent the "pareto front" (acording to NSGA 2 ) 
the function signeture is :
"def find_pareto(size,fitnesses)"
write tests for this function (and dont forget to test the edge cases )'''
