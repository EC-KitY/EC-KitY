...
from examples.multi_objective.moe_base_test.NSGAII_basic_test import NSGAIIBasicTestEvaluator


class TestNSGAIIBasicTestEvaluator:
	...
	def setup_class(self):
		...
		"""
		self.evaluator = NSGAIIBasicTestEvaluator()
	...
	def test_eval_fixed_vals(self):
		ind = GAVectorCreator(length=3, bounds=(-4, 4), fitness_type=NSGAIIFitness, vector_type=FloatVector)
