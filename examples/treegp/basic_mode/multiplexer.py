...
def main():
    ...
    print(
        "execute(s0=0, s1=1, s2=1, d1=0): expected value = 0, actual value =",
        exec1,
    )
    print(
        "execute(s0=0, s1=0, s2=1, d3=1): expected value = 1, actual value =",
        exec3,
    )
    print(
        "execute(s0=1, s1=1, s2=1, d7=1): expected value = 1, actual value =",
        exec7,
    )
