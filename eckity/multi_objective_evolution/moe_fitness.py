...
class MOEFitness(Fitness):
    ...
    def dominate(self, ind, other_fitness, other_ind):
        ...
        return all([self._o1_at_least_o2(o1,o2,h_is_b) for h_is_b,o1,o2 in zip(self.higher_is_better,self_fit,other_fit)]) and \
                any([self._o1_better_then_o2(o1,o2,h_is_b) for h_is_b,o1,o2 in zip(self.higher_is_better,self_fit,other_fit)])
